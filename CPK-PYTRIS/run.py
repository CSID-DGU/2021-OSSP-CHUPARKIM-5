...
screen = pygame.display.set_mode((board_width, board_height)) #창크기
pygame.time.set_timer(pygame.USEREVENT, framerate * 10)
pygame.display.set_caption("CPKTRIS!™")
...
main = pygame.transform.scale(main,  (board_width, board_height))

#objects
text1 = ui_variables.h2.render("original", 1, ui_variables.white)
text2 = ui_variables.h2.render("original", 1, ui_variables.red)
text3 = ui_variables.h2.render("rotate", 1, ui_variables.white)
text4 = ui_variables.h2.render("rotate", 1, ui_variables.red)
text5 = ui_variables.h2.render("dual screen", 1, ui_variables.white)
text6 = ui_variables.h2.render("dual screen", 1, ui_variables.red)
text7 = ui_variables.h2.render("blackout", 1, ui_variables.white)
text8 = ui_variables.h2.render("blackout", 1, ui_variables.red)
...
class button(): #버튼객체
    def __init__(self, board_width, board_height, x_rate, y_rate, width_rate, height_rate, text): #버튼생성
...
#button
origianl_bnt = button(board_width, board_height, 0.32, 0.35, 0.2, 0.4, text1)
rotate_bnt = button(board_width, board_height, 0.32, 0.45, 0.2, 0.4, text3)
dual_bnt = button(board_width, board_height, 0.32, 0.55, 0.2, 0.4, text5)
blackout_bnt = button(board_width, board_height, 0.32, 0.65, 0.2, 0.4, text7)
info_bnt = button(board_width, board_height, 0.32, 0.75, 0.2, 0.4, text9)
